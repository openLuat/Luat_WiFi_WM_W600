...
//#define DEMO_STD_SOCKET_SER_SEL    (DEMO_OFF)    //标准接口socket server, select 方式
...
//多播广播demo
#define DEMO_UDP_MULTI_CAST        	(DEMO_OFF) 

//socket 升级demo
#define DEMO_SOCKET_FWUP      		(DEMO_OFF)
...
//ntp demo
#define DEMO_NTP					(DEMO_OFF)

//alljoyn led demo
#define DEMO_ALLJOYN_LED            (DEMO_OFF)

//kii cloud demo
#define DEMO_KII				    (DEMO_OFF && TLS_CONFIG_CLOUD_KII)

#define DEMO_IPERF_AUTO_TEST		DEMO_OFF

#define DEMO_SSL_SERVER             (DEMO_OFF && TLS_CONFIG_SERVER_SIDE_SSL)

#define DEMO_WEBSOCKETS             (DEMO_OFF)

#define AIRM2M_MINI_PROGRAM_DEMO		(DEMO_ON)
